...
export function SwaggerEditor() {
  return (
    ...
    >
      ...
      >
        Editor oficial de swagger.io, cargado desde su sitio (con sus propias cookies y analítica).
        Si tu spec es confidencial, genera los modelos Kotlin/Java en la pestaña Modelos, que
        procesa todo en tu navegador.
      </Alert>
